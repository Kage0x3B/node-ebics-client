import h004, { type ErrorDetail } from '../H004/errors.js';

const h004t = h004.technical;
const h004b = h004.business;

const errors: { technical: Record<string, ErrorDetail | undefined>; business: Record<string, ErrorDetail | undefined> } = {
	technical: {
		'000000': h004t['000000'],
		'011000': h004t['011000'],
		'011001': h004t['011001'],
