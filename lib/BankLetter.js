...
const registerHelpers = () => {
	...
	handlebars.registerHelper('hasCertificate', k => k.hasCertificate());

	handlebars.registerHelper('certificatePem', k => k.certificatePem());

	handlebars.registerHelper('sha256', k => k.sha256());
};
